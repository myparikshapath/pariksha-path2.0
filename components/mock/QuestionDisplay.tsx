    ...
    >
      ...
      <div className="space-y-3 mb-6">
        {question.options.map((option, index) => {
          const optionOrder = index; // Use 0, 1, 2, 3 to match database order field
          const isSelected = selectedAnswer === optionOrder.toString();

          return (
            <motion.button
              key={index}
              onClick={() => onAnswerSelect(optionOrder.toString())}
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <ImageDisplay
                    ...
                    alt={`Option ${optionOrder + 1} image`}
                    className="mt-2"
                    maxWidth={400}
                    maxHeight={200}
                  />
