        ...
        <footer className="w-full bg-[#101b15] text-gray-200 pt-16 pb-2">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-y-12 md:gap-y-0 md:gap-x-28">
                ...
                <div className="md:flex-1">
                    ...
                    <ul className="space-y-2">
                        <li>
                            <Link href="/privacy" className="hover:text-[#869C51] transition-colors block">
                                Privacy Policy
                            </Link>
                        </li>
                        <li>
                            <Link href="/terms" className="hover:text-[#869C51] transition-colors block">
                                Terms & Conditions
                            </Link>
                        </li>
                        <li>
                            <Link href="/refund" className="hover:text-[#869C51] transition-colors block">
                                Refund & Cancellation
                            </Link>
                        </li>
                    </ul>
