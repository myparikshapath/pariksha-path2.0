...
export default function AdminDashboard() {
    return (
        <div className="min-h-screen bg-white px-4 sm:px-6 lg:px-10 pt-28">
            <div className="w-full mx-auto bg-white shadow-xl rounded-2xl p-4 sm:p-6 lg:p-8">
                {/* Header */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-4 sm:gap-6 cursor-pointer">
                    ...
                    <div className="bg-emerald-500 text-white p-6 rounded-xl shadow-md hover:scale-105 transition-transform h-32 flex flex-col justify-between">
                        <h2 className="text-lg font-semibold">Analytics</h2>
                        <p className="text-sm">Track usage & performance</p>
                    </div>
                    <div className="bg-emerald-700 text-white p-6 rounded-xl shadow-md hover:scale-105 transition-transform h-32 flex flex-col justify-between">
