...
const Privacy = () => {
    return (
        <div className="max-w-5xl mx-auto px-4 py-12">
            ...
            <p className="mb-6 text-gray-700">
                Parikshapath (&quot;Company&quot;, &quot;we&quot;, &quot;our&quot;, &quot;us&quot;)
                values and respects the privacy of every individual who uses our website,
                mobile application, products, and services (collectively, “Services”).
                This Privacy Policy outlines how we collect, use, disclose, and protect your
                information in compliance with the Information Technology Act, 2000, the
            ...
            <div className="space-y-8 text-gray-700">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>
                            Send updates and promotional materials (with consent)
                        </li>
